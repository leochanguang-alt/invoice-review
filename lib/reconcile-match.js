 ...
 * @param {number} [opts.dateBefore=1]
 * @param {number} [opts.dateAfter=1]
...
export function scoreInvoiceMatch(tx, invoice, opts = {}) {
    ...
    // invoice date relative to txn: allow ±1 day by default
    const dateBefore = opts.dateBefore ?? 1;
    const dateAfter = opts.dateAfter ?? 1;
    ...
    return {
        ...
        invoice: {
            ...
            file_link_r2: invoice.file_link_r2 || null,
            file_link: invoice.file_link || null,
            achieved_file_link: invoice.achieved_file_link || null,
        },
    };
}
