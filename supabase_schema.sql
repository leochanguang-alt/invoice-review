...
-- Currency List Table (country is used for auto-linking with invoice recognition results)
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    achieved_file_id TEXT,
    achieved_file_link TEXT,
    created_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_invoices_file_link_r2 ON invoices(file_link_r2);
CREATE UNIQUE INDEX IF NOT EXISTS idx_invoices_file_id_hash_r2 ON invoices(file_ID_HASH_R2);